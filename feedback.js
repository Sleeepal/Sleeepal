const feedbackCopy = {
  zh: {
    ...
    "hero.body": "在另一台电脑上测试时，把系统、平台、版本、模块和现象一次整理成反馈包。反馈系统不接收录音；截图和夜报只有在你主动选择后才会加入。",
    "privacy.label": "隐私边界",
    "privacy.title": "只收问题上下文，不收敏感音频",
    "privacy.item1": "不接收、不上传任何用户录音",
  ...
  en: {
    ...
    "hero.body": "When testing on another machine, package the platform, version, module, route, and observed issue in one pass. Feedback never accepts recordings; screenshots and night reports are included only when you choose them.",
    "privacy.label": "Privacy boundary",
    "privacy.title": "Context only, no sensitive audio",
    "privacy.item1": "No user recording is accepted or uploaded",
